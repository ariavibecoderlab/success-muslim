        ...
        <CardContent className="p-4 relative">
          ...
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-1.5">
              ...
              <p className="text-xs font-bold">Ramadan Day {ramadanDay} of 30</p>
            </div>
            <div className="flex items-center gap-1 bg-white/20 rounded-full px-2 py-0.5">
              <Flame className="h-3 w-3 text-yellow-200" />
              <span className="text-[10px] font-medium">{ramadanDay} day streak</span>
            </div>
          </div>
          ...
          {specialTitle && (
            <div className="flex items-center gap-1.5 mb-1.5">
              <Star className="h-3.5 w-3.5 text-yellow-200 flex-shrink-0" />
              <p className="text-sm font-bold">{specialTitle}</p>
            </div>
          )}

          {/* Subtitle */}
          {specialSubtitle && (
            <p className="text-[11px] opacity-80 mb-2.5">{specialSubtitle}</p>
          )}

          {/* Progress */}
          <p className="text-[10px] opacity-60 mb-1">{Math.round(progress)}% of Ramadan complete</p>
